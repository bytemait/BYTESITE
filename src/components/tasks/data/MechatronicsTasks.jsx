				...
				<div className="flex items-center gap-3 sm:gap-4">
					...
					<div className="min-w-0">
						...
						<div className="flex flex-wrap gap-2 sm:gap-3 mt-1 text-xs sm:text-sm text-gray-300 font-mono items-center">
							<span
								className={`px-2 sm:px-3 py-1 rounded-full text-white text-xs ${difficultyColors[difficulty.toLowerCase()] || difficultyColors.easy}`}
							>
								{difficulty}
							</span>
							{time && (
			...
			<AnimatePresence>
				{expanded && (
					...
					>
						...
						{outcomes && (
							<section className="mb-4 sm:mb-5">
								<h4 className="text-cyan-400 font-bold mb-2 text-sm sm:text-base">
						...
						{submission && (
							<section className="mb-4 sm:mb-5">
								<h4 className="text-orange-400 font-bold mb-2 text-sm sm:text-base">
									Submission
								</h4>
								<ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-2 text-xs sm:text-sm">
			...
			>
				...
				<div className="bg-gray-900 bg-opacity-50 rounded-xl p-4 sm:p-6 max-w-xs sm:max-w-md mx-auto">
					...
					<p className="text-xs sm:text-sm">
						WhatsApp:{" "}
						<span className="text-cyan-400">9817413427</span>
					</p>
					<p className="text-xs sm:text-sm">
						Email:{" "}
				...
				<div className="mt-6 sm:mt-8 p-3 sm:p-4 bg-green-900 bg-opacity-30 rounded-xl border border-green-500 max-w-xs sm:max-w-lg mx-auto">
					<h4 className="text-green-300 font-bold mb-2 text-sm sm:text-base">
